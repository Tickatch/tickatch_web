...
import { CreateSellerRequest, AddressRequest } from "@/types/user";
...
export default function CompleteProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 주소 객체 생성
      const businessAddress: AddressRequest | null =
          (zipCode || address1 || address2)
              ? { zipCode: zipCode || null, address1: address1 || null, address2: address2 || null }
              : null;
      ...
      if (!response.ok) {
        throw new Error(data.error?.message || "판매자 정보 등록에 실패했습니다.");
      }

      // 성공 시 판매자 페이지로 이동
      router.push("/seller");
    } catch (err) {
      setError(err instanceof Error ? err.message : "판매자 정보 등록에 실패했습니다.");
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className={cn(
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-4">사업자 정보</h3>
                </div>
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-4">
                    사업장 주소 <span className="text-gray-400 font-normal">(선택)</span>
                  </h3>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <input
                      ...
                      disabled={isLoading}
                      className={cn(
                          "col-span-2 px-4 py-3 rounded-xl",
                          "bg-gray-50 dark:bg-gray-800",
                          "border border-gray-200 dark:border-gray-700",
                          "text-gray-900 dark:text-white",
                          "placeholder:text-gray-400",
