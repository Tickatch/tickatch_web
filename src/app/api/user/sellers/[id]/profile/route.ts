...
import type { SellerResponse, UpdateSellerProfileRequest } from "@/types/user";
import type { ApiResponse } from "@/types/api";

const API_URL = process.env.NEXT_PUBLIC_API_URL;

/**
 * PUT /api/user/sellers/[id]/profile - 판매자 프로필 수정
 * @param request.body - UpdateSellerProfileRequest
...
export async function PUT(
  ...
  try {
    ...
    const body: UpdateSellerProfileRequest = await request.json();

    const response = await fetch(`${API_URL}/user/sellers/${id}/profile`, {
      method: "PUT",
