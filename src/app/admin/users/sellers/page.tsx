...
// 더미 판매자 목록
const DUMMY_SELLERS: AuthInfo[] = [
  {
    id: "seller-001",
    email: "seller1@tickatch.com",
    userType: "SELLER",
    status: "ACTIVE",
    lastLoginAt: "2025-02-25T10:30:00",
    providers: [],
    createdAt: "2025-01-15T09:00:00",
  },
  {
    id: "seller-002",
    email: "hybe@entertainment.com",
    userType: "SELLER",
    status: "ACTIVE",
    lastLoginAt: "2025-02-24T15:20:00",
    providers: ["KAKAO"],
    createdAt: "2025-01-20T11:00:00",
  },
  {
    id: "seller-003",
    email: "cj@enmmusic.com",
    userType: "SELLER",
    status: "ACTIVE",
    lastLoginAt: "2025-02-23T09:45:00",
    providers: ["GOOGLE"],
    createdAt: "2025-01-22T14:00:00",
  },
  {
    id: "seller-004",
    email: "sports@agency.com",
    userType: "SELLER",
    status: "LOCKED",
...
export default function AdminSellersPage() {
  const [sellers, setSellers] = useState<AuthInfo[]>([]);
  ...
  const stats = {
    ...
    locked: sellers.filter((s) => s.status === "LOCKED").length,
    withdrawn: sellers.filter((s) => s.status === "WITHDRAWN").length,
  };
